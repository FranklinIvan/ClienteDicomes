...
<div class="container text-gray-900">
    ...
    <div class="modal-body">
        <div class="text-center">
            <img class="rounded-circle" src="../images/imagesDB/profile.png" alt="Fotografía" style="width: 150px; height: 150px">
        </div>
        <div class="form-group">
            <label> <span class="font-weight-bold">Nombre:</span> Cliente </label>
        </div>
        <div class="form-group">
            <label> <span class="font-weight-bold">Apellido:</span> UTP </label>
        </div>
        <div class="form-group">
            <label> <span class="font-weight-bold">Correo:</span> cliente@utp.ac.pa </label>
        </div>
        <hr>
    </div>
        ...
        <div class="modal-body">
            <div id="mostrarEditar" style="display: none;">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nombre" value="Cliente" required>
                </div>
                <div class="form-group">
